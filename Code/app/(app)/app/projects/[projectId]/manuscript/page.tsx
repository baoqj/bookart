  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>/</span>
        <Link href={`/app/projects/${projectId}`} className="hover:text-foreground">
          {t("projectDetails")}
        </Link>
        <span>/</span>
      ...
      <div className="flex items-center justify-between">
        ...
        {chapters.length > 0 && (
          <Button onClick={() => router.push(`/app/projects/${projectId}/illustrations`)}>
            {t("continue")}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex justify-end mt-4 gap-2">
              <Button variant="outline" onClick={() => router.push(`/app/projects/${projectId}/illustrations`)}>
